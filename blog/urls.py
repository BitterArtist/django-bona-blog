...
from blog.views.blog.comment_views import CommentCreateView, ArticleCommentList
...
urlpatterns = [
    ...
    # account/login/
    path(route="account/register/", view=UserRegisterView.as_view(), name="register"),
    # account/logout/
    path(route="account/logout/", view=UserLogoutView.as_view(), name="logout"),
    path(
        route="account_activation_sent/",
        view=AccountActivationSentView.as_view(),
        name="account_activation_sent",
    ),
    path(
        route="activate/<uidb64>/<token>/", view=ActivateView.as_view(), name="activate"
    ),
    # DASHBOARD URLS #
    # /author/dashboard/
    path(
    ...
    # me/article/write
    path(
        route="me/article/write/", view=ArticleWriteView.as_view(), name="article_write"
    ),
